...
<div class="content-report">
	<a role="button" data-toggle="collapse" href="#panel-search" aria-expanded="false" onclick="search_day();"  class="btn btn-success"><span class="glyphicon glyphicon-search"></span> ค้นหาข้อมูลมาสาย แบบรายวัน</a>
...
<script type="text/javascript">
	function submit_day(){
        ...
        url: '<?php echo base_url() ?>report/search_by_day', // override for form's 'action' attribute 
	...
	function search_day(){
		$.ajax({
			url: '<?php echo base_url() ?>report/form_day',
			type: 'GET',
			success:function(data){
	...
	function search_peple(){
		$.ajax({
			url: '<?php echo base_url() ?>report/form_peple',
			type: 'GET',
			success:function(data){
    			$("#panel-search").on('show.bs.collapse');
				$(".well").html(data);
