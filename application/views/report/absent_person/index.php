...
<form id="frmFindDay" class="form-horizontal" role="form" enctype="multipart/form-data">
  <fieldset>
    ...
    <label for="to_date"  class="col-lg-2 control-label"><b>วันที่ : </b></label>
  	<div class="col-md-2">
    	<input type="text" name="from_date" value=""  required="required" id="from_date" class="form-control" placeholder="จาก"/>
  	</div>
  	<div class="col-md-2">
  		<input type="text" name="to_date" value=""  required="required" id="to_date" class="form-control" placeholder="ถึง"/>
  	</div>
    </div>
   <div class="form-group">
