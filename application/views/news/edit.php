...
<div id="page-wrapper" >
  <legend>เพิ่ม News</legend>
        ...
        <?php endif; ?>
				<form id="frmNews" method="POST" action="<?php echo base_url(); ?>news/editsave" class="form-horizontal" role="form" enctype="multipart/form-data">
  				<fieldset>
    			<div class="form-group inline">
    			<label for="holi_date"  class="col-lg-3 control-label"><b>ข้อความข่าว (255 ตัวอักษร) : </b></label>
  				<div class="col-md-6">
    			<textarea name="new" required maxlength="249" cols="60" rows="10" class="form-control"><?php echo $data[0]['NEW']; ?></textarea>
  				  <input type="hidden" name="newidx" value="<?php echo $data[0]['NEWIDX']; ?>">
  				</div>
    			</div>
    			<hr>
